...
export default {
  ...
  async execute(message, args, client) {
    ...
    if (subcommand === 'config') {
      ...
      let valueStart = args.slice(3).join(' ').replace(/\\n/g, '\n');
