...
import prefix from '../../prefix/Welcome/goodbye.js';
import { buildMessageFromInteraction } from './_util.js';

export default {
  data: new SlashCommandBuilder()
    .setName('goodbye')
    .setDescription('Configure the goodbye message system with multi-channel support.')
    .addSubcommand(sub => sub
      .setName('show')
      .setDescription('Show the current goodbye configuration'))
    .addSubcommand(sub => sub
      .setName('add')
      .setDescription('Add a goodbye channel')
      ...
      .addStringOption(o => o
        .setName('message')
        .setDescription('The goodbye message (supports placeholders and embed syntax)')
        .setRequired(false))
    ...
    .addSubcommand(sub => sub
      .setName('list')
      .setDescription('List all configured goodbye channels'))
    .addSubcommand(sub => sub
      .setName('config')
      .setDescription('Configure a goodbye channel')
      .addChannelOption(o => o
        .setName('channel')
    ...
    .addSubcommand(sub => sub
      .setName('toggle')
      .setDescription('Toggle goodbye messages on/off'))
    .addSubcommand(sub => sub
      .setName('enable')
    ...
    .addSubcommand(sub => sub
      .setName('reset')
      .setDescription('Reset all goodbye settings')),
  ...
  async execute(interaction) {
    ...
    let rawContent = `goodbye ${subcommand}`;
