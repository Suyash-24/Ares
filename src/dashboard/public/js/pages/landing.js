...
<a class="text-slate-400 hover:text-white transition-colors" href="#">Signals</a>
</nav>
<div class="flex items-center gap-4 text-purple-300 dark:text-purple-200">
...
<button class="px-10 py-5 rounded-xl bg-gradient-to-r from-primary to-primary-container text-on-primary font-headline font-bold uppercase tracking-widest text-sm shadow-[0_0_30px_rgba(132,85,239,0.3)] hover:shadow-[0_0_45px_rgba(132,85,239,0.5)] transition-all duration-300 active:scale-95">
                    Initialize Bridge
                </button>
<button class="px-10 py-5 rounded-xl border border-secondary/30 text-secondary font-headline font-bold uppercase tracking-widest text-sm hover:bg-secondary/5 transition-all duration-300 active:scale-95">
                    View Systems
                </button>
</div>
</section>
...
<img alt="Abstract digital nebula" class="w-full h-full object-cover opacity-30 mix-blend-screen group-hover:scale-110 transition-transform duration-1000" data-alt="abstract flowing fluid dynamics with purple and cyan neon colors glowing against a dark cosmic background digital art" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDAmL5P7KnP-QvfgCwPgABdIjNz9d0drqH-DreZokcQiRctF8ios4hq8NXNAriBGnZI5UNc81KENuctOwIxNQlaVgBZOVFk8ffgxTv_hXkTP0SCIUxoUCELaMIiIrGKZNM_hKipkaanBWI0ywnRHngLkG_MbH83CXy6xPgcwHt7vbiDkA5WqQm-s5WZSLjIOf0TeZE5P5CBMBGIzRynPRs7ir8osvjUeTbOCZnBR9BSic-D1vBQVrG8pPcVLt1E9JDCQDHlDFlQuyk"/>
...
<a class="inline-flex items-center gap-2 font-headline font-bold text-xs uppercase tracking-widest text-secondary group/link" href="#">
                        Explore Modules 
...
<span class="font-['Space_Grotesk'] text-[10px] font-bold uppercase tracking-widest mt-1">Nebula</span>
</div>
<div class="flex flex-col items-center justify-center text-slate-500 hover:text-purple-300 cursor-pointer hover:scale-110 active:scale-90 transition-all duration-300">
<span class="material-symbols-outlined">rocket_launch</span>
<span class="font-['Space_Grotesk'] text-[10px] font-bold uppercase tracking-widest mt-1">Tactical</span>
</div>
<div class="flex flex-col items-center justify-center text-slate-500 hover:text-purple-300 cursor-pointer hover:scale-110 active:scale-90 transition-all duration-300">
<span class="material-symbols-outlined">sensors</span>
<span class="font-['Space_Grotesk'] text-[10px] font-bold uppercase tracking-widest mt-1">Signals</span>
</div>
<div class="flex flex-col items-center justify-center text-slate-500 hover:text-purple-300 cursor-pointer hover:scale-110 active:scale-90 transition-all duration-300">
<span class="material-symbols-outlined">layers</span>
<span class="font-['Space_Grotesk'] text-[10px] font-bold uppercase tracking-widest mt-1">Log</span>
</div>
</nav>
<!-- Footer Content -->
...
<li><a class="hover:text-primary transition-colors" href="#">Commands</a></li>
<li><a class="hover:text-primary transition-colors" href="#">Permissions</a></li>
</ul>
</div>
<div>
...
<img alt="Discord" class="w-5 h-5 opacity-70" data-alt="Discord logo simple flat icon white" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDkkkPtBL0mtVA39dZl5fzqdwgMDiX2IX4rrgBAFAQ_YsNdytkMRO2OfVPDn8ZJRMqKCdUK7ANcRCFg_ybNuGvzOzk9sfzPrjS-XNvpODt_ysy9OmzxRH8K9gi3BFl_yeQEaZiolPPrXTTAmWQETvwnBXrXr5V2M-pfBvxDDh_ASDlX5gaOJZ1wBGW2PKwDX0MMdznjl06C8_GcAzlDhLUXGuI16z-JR66Vk57KsnC3RgbzijoyLN0uHmqc6dgZHXSj3CalTz643Ds"/>
</a>
<a class="w-10 h-10 rounded-lg bg-surface-container flex items-center justify-center hover:bg-surface-container-high transition-colors" href="#">
<img alt="X" class="w-5 h-5 opacity-70" data-alt="Twitter X social media icon white minimal" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCYta076EKO-OiNYoB0NapIxluiNSIB9fZyASO9PcZKo_hvIEFrUo1WajbKfFbdoJiT36eUeIkJrlShdHsHIAwOIlM_dfDsODY1huu_Ix2eGDFfYRTrxUOOWnxm_jM1GqhyPxx1lLlsU-Q8WFBb_BsydxQutTU5aqJttBtwixPMQ-arNMQotkG7hBH1yrnnOA4LVZn5lUPiGsUNJ9hHy3JmkQXeBA0OWthTM0ih8_KcUwT6UvezzMkf3LwOBwW68wJG0IDwWchteQM"/>
</a>
</div>
</div>
</div>
</div>
<div class="max-w-7xl mx-auto mt-20 pt-10 border-t border-outline-variant/10 flex flex-col md:row justify-between items-center gap-4">
<span class="font-label text-[10px] text-slate-500 uppercase tracking-widest">© 2024 Ares Intelligence Systems. All Rights Reserved.</span>
